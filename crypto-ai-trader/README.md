# Aiterra v1.2.0 — คู่มือผู้ใช้ภาษาไทย

---

## 1. ภาพรวม

**Aiterra v1.2.0** คือระบบซื้อขายสกุลเงินดิจิทัลอัตโนมัติที่ขับเคลื่อนด้วย AI โดยมีความสามารถดังนี้:
...
*เวอร์ชัน 1.2.0 | พัฒนาด้วย FastAPI + Python + AI*
