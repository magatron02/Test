    ...
    async def _handle_general(self, message: str) -> dict:
        ...
        try:
            ...
            try:
                ...
                db.close()
            sys_prompt = f"คุณคือ Lunai — AI trading assistant ภายใน Aiterra ตอบสั้น กระชับ เป็นภาษาไทย recent trades: {trade_ctx}"
...
async def test_notifications(data: Dict[str, Any] = None):
    ...
    msg = "🧪 Lunai (Aiterra) — การแจ้งเตือนทดสอบ / Test notification ✅"
    results = {}
